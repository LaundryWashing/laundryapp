  ...
  return (
    ...
    <ScrollView>
      <View style={{backgroundColor:"#FEBE10",padding:12}}>
        <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
            <View style={{flexDirection:"row",alignItems:"center",gap:10}}>
                <Pressable style={{width:30,height:30,borderRadius:15,backgroundColor:"#A0A0A0",
      ...
      <View style={{marginTop:16,flexDirection:"row",alignItems:"center",justifyContent:"space-around"}}>
        <Pressable onPress={()=> setSelectedOption("Wash + fold")}
        style={{backgroundColor:"white",width:80,height:80,justifyContent:"center",
                           alignItems:"center",borderRadius:5,borderWidth:1,
                           borderColor: selectedOption == "Wash + fold" ? "#0066b2" : "transparent"
        }}>
        ...
        <Pressable onPress={()=> setSelectedOption("Wash + Iron")}
        style={{backgroundColor:"white",width:80,height:80,justifyContent:"center",
                           alignItems:"center",borderRadius:5,borderWidth:1,
                           borderColor: selectedOption == "Wash + Iron" ? "#0066b2" : "transparent"
        }}>
            <Image style={{width:40,height:40}}
                source = {{
        ...
        <Pressable onPress={()=> setSelectedOption("Steam Iron")}
        style={{backgroundColor:"white",width:80,height:80,justifyContent:"center",
                           alignItems:"center",borderRadius:5,borderWidth:1,
                           borderColor: selectedOption == "Steam Iron" ? "#0066b2" : "transparent"
        }}>
            <Image style={{width:40,height:40}}
                source = {{
        ...
        <Pressable onPress={()=> setSelectedOption("Dry Clean")}
        style={{backgroundColor:"white",width:80,height:80,justifyContent:"center",
                           alignItems:"center",borderRadius:5,borderWidth:1,
                           borderColor: selectedOption == "Dry Clean" ? "#0066b2" : "transparent"
        }}>
            <Image style={{width:40,height:40}}
                source = {{
      ...
      <View>
        <View style={{marginVertical:20,flexDirection:"row",alignItems:"center",gap:10,justifyContent:"space-around"}}>
            <Pressable onPress={()=> setOption("Men")}
            style={{padding:10,backgroundColor:option == "Men" ? "#0066b2" : "white",width:60,borderRadius:4}}>
                <Text style={{fontSize:14,fontWeight:"500",textAlign:"center",color:option=="Men" ? "white" : "gray"}}>
                    Men
                </Text>
            </Pressable>
            <Pressable onPress={()=> setOption("Women")}
            style={{padding:10,backgroundColor:option == "Women" ? "#0066b2" : "white",width:70,borderRadius:4}}>
                <Text style={{fontSize:14,fontWeight:"500",textAlign:"center",color:option=="Women" ? "white" : "gray"}}>
                    Women
                </Text>
            </Pressable>
            <Pressable onPress={()=> setOption("Kids")}
            style={{padding:10,backgroundColor:option == "Kids" ? "#0066b2" : "white",width:60,borderRadius:4}}>
                <Text style={{fontSize:14,fontWeight:"500",textAlign:"center",color:option=="Kids" ? "white" : "gray"}}>
                    Kids
                </Text>
            </Pressable>
            <Pressable onPress={()=> setOption("Household")}
            style={{padding:10,backgroundColor:option == "Household" ? "#0066b2" : "white",borderRadius:4}}>
                <Text style={{fontSize:14,fontWeight:"500",textAlign:"center",color:option=="Household" ? "white" : "gray"}}>
                    Household
                </Text>
            </Pressable>
        </View>
         ...
         {option == "Women" && (
            <View>
                {womenData?.map((item,index)=>(
                    <Pressable key={index}
                    style={{padding:10,backgroundColor:"white",marginVertical:13,flexDirection:"row",alignItems:"center",gap:12}}>
                    <View>
                        <Image style={{width:40,height:40}}
                    ...
                    <Text style={{marginTop:3}}>
                        ...
                        {selectedOption == "Wash + Iron" ? item.price + 20 :
                           ...
                           selectedOption == "Dry Clean" ? item.price + 45 : item.price}
                    </Text>
                    </View>
    ...
    {cart.length > 0 && (
      <Pressable style={{backgroundColor:"#E0E0E0",padding:10}}>
        <View style={{flexDirection:"row",alignItems:"center",gap:12}}>
          ...
          <Pressable onPress={()=> router.push("/basket/cart")}
